...
public class UIHud {
    ...
    public void createGameOverPanel(){
        ...
        endScore.setPosition(GameInfo.WIDTH / 2f, GameInfo.HEIGHT / 2f + 20, Align.center);
        endCoinScore.setPosition(GameInfo.WIDTH / 2f, GameInfo.HEIGHT / 2f - 45, Align.center);
